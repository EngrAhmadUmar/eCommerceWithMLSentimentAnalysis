    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefijklm1234567', length=10, max_length=30, prefix='cat', unique=True)),
                ('title', models.CharField(default='Cars Defaulto', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='89.99', max_digits=999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='89.99', max_digits=999999999999)),
                ('total', models.DecimalField(decimal_places=2, default='0', max_digits=999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefijklm1234567', length=10, max_length=30, prefix='', unique=True)),
                ('title', models.CharField(default='Sxn Store Product', max_length=100)),
                ('image', models.ImageField(default='product.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is a sxn product', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='89.99', max_digits=999999999999)),
                ('oldprice', models.DecimalField(decimal_places=2, default='95.99', max_digits=999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefijklm1234567', length=10, max_length=30, prefix='ven', unique=True)),
                ('title', models.CharField(default='Sxn Vendor Store', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is a sxn vendor', null=True)),
                ('address', models.CharField(default='123 Sxn Destroyers', max_length=100)),
